...
game_font = pygame.font.Font(None, 30)  # Создаём шрифт для игры

screen_width, screen_height = 800, 600  # Создаём размер экрана
screen_fill_color = (32, 52, 71)  # Создаём цвет фона игры
screen = pygame.display.set_mode((screen_width, screen_height))

pygame.display.set_caption('Awesome Shooter Game')  # Создаём название игры
